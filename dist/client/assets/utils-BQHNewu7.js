...
const Ee = (e, t) => {
	...
	Ke = (e) => {
		...
		if (t) {
			const i = t + ge,
				m = o;
			o = (a) =>
				a.startsWith(i) ? m(a.slice(i.length)) : he(He, !1, a, void 0, !0);
		}
		if (r) {
			const i = o;
	...
	to = (e, ...t) => {
		...
		const a = (d) => {
				...
				return (
					(r = Ze(u)), (o = r.cache.get), (i = r.cache.set), (m = b), b(d)
				);
			},
			b = (d) => {
				const u = o(d);
	...
	Ao = () => {
		...
		return {
			...
			classGroups: {
				...
				"max-w": [
					{ "max-w": [b, "screen", "none", "prose", { screen: [a] }, ...j()] },
				],
				h: [{ h: ["screen", "lh", ...j()] }],
